...
func TestOllamaBrainGenerateRating(t *testing.T) {
	...
	testGenerateRating(t, ctx, gen, baseprompt+"Bitcoin will be banned in the US in 2026 - CNN", 0, 30)
	...
	testGenerateRating(t, ctx, gen, baseprompt+"El Salvador buys Bitcoin dip, adding 5 BTC amid price plunge to $83,000 - Crypto Briefing", 40, 90)
